This is a port of [Tor](https://www.torproject.org) (and its unported dependency ie [Libevent](http://libevent.org/)) to [NaCl](https://developer.chrome.com/native-client) platform on Chrome.  
